<x-main>
    <div id="tableExample3" data-list='{"valueNames":["id","name","email","age" , "phone"],"page":10,"pagination":true}'>
        <a href="{{ route('students_create') }}"> <button type="button" class="btn btn-primary mt-5"> O'quvchi +</button></a>
        ...
        <div class="table-responsive scrollbar">
            <table class="table table-bordered table-striped fs--1 mb-0">
                ...
                @foreach($students as $student)
                    @if($student->status === 1 && $student->active === 1)
                <tr  >
                        ...
                        <div class="dropdown font-sans-serif position-static">
                            ...
                            <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-24">
                                <div class="py-2">
                                    ...
                                    <a class="dropdown-item" href="{{ route('student.edit' , ['student' => $student->id]) }}">O'zgartirish</a>
